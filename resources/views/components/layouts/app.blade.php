        ...
        <nav class="flex flex-1 flex-col gap-1 overflow-y-auto p-3 text-sm">
            @php
                $icons = [
                    ...
                    'banknotes'     => '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />',
                    ...
                    'trending'      => '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />',
                ...
                $groups = [
                    'عملیات' => [
                        ...
                        ['customers.index', 'مشتریان', 'user'],
                        ['estimates.index', 'برآوردها', 'document'],
                        ['jobs.index', 'کارها', 'wrench'],
                        ['schedule', 'تقویم', 'calendar'],
                        ['invoices.index', 'فاکتورها', 'banknotes'],
                        ['materials.index', 'مواد', 'archive'],
                    ],
                    'امور مالی' => [
                        ['finance', 'نمای مالی', 'chart'],
                        ['accounts.index', 'حساب‌ها', 'bank'],
                        ['transactions.index', 'تراکنش‌ها', 'card'],
                        ['bills.index', 'بل‌ها', 'receipt'],
                        ['suppliers.index', 'تأمین‌کنندگان', 'truck'],
                        ['employees.index', 'کارمندان', 'id'],
                        ['payroll.index', 'لیست حقوق', 'money'],
                    ],
                    'گزارش‌ها' => [
                        ['reports.income', 'صورت سود و زیان', 'trending'],
                        ['reports.balance', 'بیلانس', 'scale'],
                        ['reports.monthly', 'گزارش ماهانه', 'calendar-days'],
                    ],
                    'سیستم' => [
                        ['settings.company', 'تنظیمات', 'cog'],
                    ],
                ];
            @endphp
