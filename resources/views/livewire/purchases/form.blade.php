<div class="mx-auto max-w-4xl">
    <form wire:submit="save" class="space-y-6">
        <div class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <div class="sm:col-span-2">
                    <label class="mb-1 block text-sm font-medium text-stone-700">تأمین‌کننده *</label>
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-stone-700">شماره بل</label>
                    <input type="text" wire:model="reference" placeholder="شماره فاکتور تأمین‌کننده" class="w-full rounded-lg border border-stone-300 px-3 py-2 text-sm focus:border-amber-500 focus:ring-amber-500">
                </div>
                <div>
                    <label class="mb-1 block text-sm font-medium text-stone-700">اتصال به پروژه</label>
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-stone-700">تاریخ بل *</label>
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('bills.index') }}" wire:navigate class="rounded-lg px-4 py-2 text-sm font-medium text-stone-600 hover:bg-stone-100">لغو</a>
            <button type="submit" class="rounded-lg bg-amber-600 px-5 py-2 text-sm font-semibold text-white hover:bg-amber-700">ذخیره بل</button>
        </div>
    </form>
</div>
