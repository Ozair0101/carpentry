    ...
    <form wire:submit="save" class="space-y-6">
        <div class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-stone-700">Issue date *</label>
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-stone-700">Valid until</label>
        ...
        <div class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
            <h3 class="mb-4 font-semibold text-stone-800">Line items</h3>
        ...
        <div class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
            <div class="grid gap-5 sm:grid-cols-2">
                <div>
                    <label class="mb-1 block text-sm font-medium text-stone-700">Notes (shown on estimate)</label>
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-stone-700">Terms</label>
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('estimates.index') }}" wire:navigate class="rounded-lg px-4 py-2 text-sm font-medium text-stone-600 hover:bg-stone-100">Cancel</a>
            <button type="submit" class="rounded-lg bg-amber-600 px-5 py-2 text-sm font-semibold text-white hover:bg-amber-700">Save estimate</button>
        </div>
    </form>
</div>
